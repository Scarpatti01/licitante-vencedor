...
export const metadata: Metadata = {
  ...
  openGraph: { title: TITULO, description: DESCRICAO, url: `${SITE.url}/contratos/`, type: "article" },
};
        ...
        <div className="mt-12 space-y-12">
          ...
          <Secao id="sancoes" titulo="Sanções: da advertência à inidoneidade">
            ...
            <P>
              ...
              Multa aplicada por e-mail do fiscal, sem processo, é nula — e
              contestar no prazo é obrigação sua, porque sanção não impugnada se
