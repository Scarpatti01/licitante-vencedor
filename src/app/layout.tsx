...
export const metadata: Metadata = {
  ...
  robots: {
    ...
    // Discover. Só passou a fazer sentido agora: antes dos `opengraph-image`
    // desta mesma mudança não havia imagem nenhuma para exibir — o
    // `twitter.card: "summary_large_image"` logo acima prometia uma desde
